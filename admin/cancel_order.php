  ...
  <style type="text/css">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Danh sách hóa đơn đã hủy</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="container">
          ...
          <table class="table table-bordered mt-3 .bg-light">
            ...
            <?php
               ...
               $query=mysqli_query($conn,"SELECT DISTINCT orderid, user_id, status FROM tblorderdetails INNER JOIN tblorder ON tblorderdetails.orderid=tblorder.id WHERE status=3 ORDER BY orderid LIMIT $perRow, $rowsPerPage");
                $totalRows = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM tblorder WHERE status=3"));
