<!DOCTYPE html>
    ...
    <head>
        <meta charset="utf-8">
          ...
          <title>Sản phẩm tạm ngưng bán</title>
  ...
  <style type="text/css">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Sản phẩm tạm ngưng bán</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <table class="table table-bordered mt-3 .bg-light">
            ...
            <?php
                ...
                $perRow = $page*$rowsPerPage-$rowsPerPage;
                 ...
                 $query = mysqli_query($conn, "SELECT * FROM sanpham WHERE TrangThai=0 LIMIT $perRow, $rowsPerPage");
                  $totalRows = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM sanpham WHERE TrangThai=0"));
