  ...
  <style type="text/css">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Thống kê sản phẩm</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="container">
          ...
          <table class="table table-bordered mt-3 .bg-light">
            ...
            <?php
                ...
                $query=mysqli_query($conn,"SELECT DISTINCT sanphamid FROM tblorderdetails ORDER BY sanphamid LIMIT $perRow, $rowsPerPage");
                $totalRows = mysqli_num_rows(mysqli_query($conn, "SELECT DISTINCT sanphamid FROM tblorderdetails"));
            ...
            <tr>
                ...
                <td>
                  <?php 
                    $rsTong = mysqli_query($conn, "SELECT * FROM tblorderdetails INNER JOIN tblorder ON tblorderdetails.orderid=tblorder.id Where sanphamid='$masp' AND (status=1 OR status=2 OR status=0)");
                    $tongSL =0;
                    while($rSL = mysqli_fetch_assoc($rsTong))
                    {
                       $tongSL += $rSL['soluong'];
                    }
                    echo $tongSL; 
